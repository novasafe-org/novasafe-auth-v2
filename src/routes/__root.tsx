...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NovaSafe — Sign in" },
      {
        name: "description",
        content: "Sign in to NovaSafe — your zero-knowledge encrypted identity vault.",
      },
      { name: "author", content: "NovaSafe" },
      { property: "og:title", content: "NovaSafe — Sign in" },
      {
